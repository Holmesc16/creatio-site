	...
	return (
		<StyledContent>
			...
			<Row style={{position: "relative"}}>
				<StyledSearchBar onFocus={() => setIsActive(true)} onBlur={() => setIsActive(false)} placeholder="Discover templates now!" />
				<StyledSearchButton>
					<SearchIcon
						width="2.5rem"
						primary={'white'}
				...
				<StyledSearchHelper isActive={isActive}>search examples: "react, vue, _lodash" "progressive web app" "username01-react"</StyledSearchHelper>
			</Row>
		</StyledContent>
	)
}
